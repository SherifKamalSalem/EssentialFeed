...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader, imageLoader: FeedImageDataLoader) -> FeedViewController {
        ...
        let presenter = FeedPresenter(view: FeedImageAdapter(controller: feedController, imageLoader: imageLoader), loadingView: WeakRefVirtualProxy<FeedRefreshViewController>(refreshController))
